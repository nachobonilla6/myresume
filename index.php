...
<head>
    ...
    <title>Ignacio Bonilla Landing page | Free Bootstrap 4.3.x landing page</title>
    <!-- font icons -->
...
<body data-spy="scroll" data-target=".navbar" data-offset="40" id="home">
    ...
    <header class="header">
        <div class="container">
            ...
            <div class="header-content">
                ...
                <h6 class="header-mono">Web Designer | ENG–SP Translator | Spanish Teacher</h6>
                <a href="{{ asset('cv.pdf') }}" target="_blank" class="btn btn-primary btn-rounded"><i class="ti-printer pr-2"></i>Print Resume</a>
            </div>
        </div>
    </header>
            ...
            <div class="collapse mt-sm-20 navbar-collapse" id="navbarSupportedContent">
                ...
                <ul class="navbar-nav brand">
                    ...
                    <li class="brand-txt">
                        ...
                        <div class="brand-subtitle">Web Designer | EN-ES Translator | Spanish Teacher</div>
                    </li>
                </ul>
    ...
    <div class="container-fluid">
        <div id="about" class="row about-section">
            <div class="col-lg-4 about-card">
                ...
                <h5 class="mb-3">Web Designer | Professional Translator (EN-ES) | Spanish Teacher</h5>
                <p class="mt-20">I offer professional services in three key areas: <strong>Web Design & Development</strong> to create stunning and functional websites, <strong>Professional Translation (EN-ES)</strong> for accurate and culturally-adapted documents, and <strong>Spanish Language Instruction</strong> with customized lessons for all levels. Let's work together to bring your digital projects to life, break language barriers, or master the Spanish language!</p>
                <a href="{{ route('download.cv') }}" class="btn btn-outline-danger"><i class="icon-down-circled2"></i>Download My CV</a>
            </div>
            <div class="col-lg-4 about-card">
                <h3 class="font-weight-light">Personal Info</h3>
                <span class="line mb-5"></span>
                <ul class="mt40 info list-unstyled">
                    <li><span>Email</span> : nachobonilla6@gmail.com</li>
                    <li><span>Phone</span> : +506 8968-1451</li>
                    <li><span>Skype</span> : nachobonilla6</li>
                    <li><span>Location</span> : Jacó Beach, Costa Rica</li>
                </ul>
                <ul class="social-icons pt-3">
            ...
            <div class="col-lg-4 about-card">
                ...
                <div class="row">
                    ...
                    <div class="col-10 ml-auto mr-3">
                        <h6>Web Design</h6>
                        <p class="subtitle">Creating beautiful, responsive websites with modern design principles.</p>
                        <hr>
                    </div>
                </div>
                <div class="row">
                    ...
                    <div class="col-10 ml-auto mr-3">
                        <h6>Translation</h6>
                        <p class="subtitle">Professional EN-ES translations with cultural adaptation.</p>
                        <hr>
                    </div>
                </div>
                <div class="row">
                    ...
                    <div class="col-10 ml-auto mr-3">
                        <h6>Spanish Teaching</h6>
                        <p class="subtitle">Customized Spanish lessons for all proficiency levels.</p>
                        <hr>
                    </div>
                </div>
                    ...
                    <div class="card">
                       <div class="card-header">
                        ...
                        <div class="card-body">
                            ...
                            <P>Freelance Translator (EN-ES)</P>
                            <P class="subtitle">Specializing in document translation, website localization, and cultural adaptation. Delivering accurate and culturally appropriate translations for various industries including legal, technical, and educational content.</P>
                            <hr>
                            <h6 class="title text-danger">2022 - Present</h6>
                            <P>Language Instructor (Spanish & English)</P>
                            <P class="subtitle">Providing personalized language instruction both in-person and online. Teaching Spanish to English speakers and English to Spanish speakers, with customized lesson plans tailored to individual learning goals and proficiency levels. Specializing in conversational practice, grammar, and cultural immersion.</P>
                            <hr>
                            <h6 class="title text-danger">2018 - 2025</h6>
                            <P>Bilingual Collections Representative</P>
                            <P class="subtitle">Managed accounts receivable and collections in both English and Spanish, negotiating payment arrangements and resolving billing inquiries. Provided exceptional customer service while maintaining professionalism in sensitive financial discussions with clients.</P>
                        </div>
                    </div>
                </div>
                <div class="col-md-6 col-lg-4">
                    <div class="card">
                       <div class="card-header">
                        ...
                        <div class="card-body">
                            ...
                            <P>Technical Course in Web Design & Development</P>
                            <P class="subtitle">Completed a technical program at Universidad Fidelitas, focusing on web design, front-end development, and creating responsive websites using modern technologies.</P>
                            <hr>
                            <h6 class="title text-danger">2022 - 2023</h6>
                            <P>Technical Degree in Teaching Spanish as a Second Language</P>
                            <P class="subtitle">Completed a technical program at Tecnológico de Costa Rica (TEC), specializing in teaching methodologies, linguistic fundamentals, and cultural aspects of Spanish language instruction for non-native speakers.</P>
                            <hr>
                            <h6 class="title text-danger">2019 - 2020</h6>
                            <P>TESOL Certification (120 hours)</P>
                            <P class="subtitle">Intensive training in Teaching English to Speakers of Other Languages, focusing on communicative language teaching, lesson planning, and classroom management. Developed skills in creating engaging activities, assessing language proficiency, and adapting teaching methods for diverse learning styles and cultural backgrounds.</P>
                    ...
                    <div class="card">
                       <div class="card-header">
                        ...
                        <div class="card-body pb-2">
                            ...
                            <h6>English-Spanish Translation</h6>
                            <div class="progress mb-3">
                                <div class="progress-bar bg-danger" role="progressbar" style="width: 100%" aria-valuenow="100" aria-valuemin="0" aria-valuemax="100"></div>
                            </div>

                            <h6>Spanish & English Teaching</h6>
                            <div class="progress mb-3">
                                <div class="progress-bar bg-danger" role="progressbar" style="width: 100%" aria-valuenow="100" aria-valuemin="0" aria-valuemax="100"></div>
                            </div>
                            <h6>HTML5 & CSS3</h6>
                    ...
                    <div class="card mb-5">
                       <div class="card-header has-icon">
                        ...
                        <div class="card-body px-4 py-3">
                            <h5 class="mb-3 card-title text-dark">Professional Translation</h5>
                            <P class="subtitle">Accurate and culturally adapted English-Spanish translations for documents, websites, and multimedia content. Specializing in legal, technical, and educational translations with fast turnaround times and attention to linguistic nuances that make a difference in your international communications.</P>
                        </div>
                    </div>
                </div>
                <div class="col-md-4 col-sm-6">
                    <div class="card mb-5">
                       <div class="card-header has-icon">
                        ...
                        <div class="card-body px-4 py-3">
                            <h5 class="mb-3 card-title text-dark">Language Instruction</h5>
                            <P class="subtitle">Customized Spanish and English lessons tailored to your learning style and goals. Whether you're a beginner or advanced learner, I provide engaging, practical instruction focused on conversation, grammar, and cultural understanding to help you achieve fluency and confidence in your target language.</P>
                        </div>
                    </div>
                </div>
                <div class="col-md-4 col-sm-6">
                    <div class="card mb-5">
                       <div class="card-header has-icon">
                        ...
                        <div class="card-body px-4 py-3">
                            ...
                            <P class="subtitle">Modern, responsive website development using the latest technologies. I create fast, secure digital experiences including Landing Pages, Business Websites, E-commerce, and Inventory Systems. From simple online presence to complex applications, I'll help you establish a strong digital footprint and achieve your business goals.</P>
                        </div>
                    </div>
                </div>
    ...
    <section class="section bg-custom-gray" id="price">
        <div class="container">
            <h1 class="mb-5"><span class="text-danger">Services</span> </h1>
            <div class="row align-items-center">
                <div class="col-md-6 col-lg-3">
                    <div class="price-card text-center mb-4">
                        <h3 class="price-card-title">Basic Translation</h3>
                        <div class="price-card-cost">
                            <sup class="ti-money"></sup>
                            <span class="num">0.08</span>
                            <span class="date">per word</span>
                        </div>
                        <ul class="list">
                            <li class="list-item">General <span class="text-muted">Documents</span></li>
                            <li class="list-item">Standard <span class="text-muted">Turnaround Time</span></li>
                            <li class="list-item">Up to <span class="text-muted">1000 words</span></li>
                            <li class="list-item">Basic <span class="text-muted">Formatting</span></li>
                        </ul>
                        <a href="#contact">
                            <button class="btn btn-primary btn-rounded w-lg">Get a Quote</button>
                        </a>
                    </div>
                </div>
                <div class="col-md-6 col-lg-3">
                    <div class="price-card text-center mb-4">
                        <h3 class="price-card-title">Professional Translation</h3>
                        <div class="price-card-cost">
                            <sup class="ti-money"></sup>
                        ...
                        <ul class="list">
                            <li class="list-item">Up to <span class="text-muted">5000 words</span></li>
                            <li class="list-item">Faster <span class="text-muted">Turnaround</span></li>
                            <li class="list-item">Technical & <span class="text-muted">Business </span></li>
                            <li class="list-item">Formatting <span class="text-muted">Included</span></li>
                        </ul>
                        <a href="#contact">
                            <button class="btn btn-primary btn-rounded w-lg">Get a Quote</button>
                        </a>
                ...
                <div class="col-md-6 col-lg-3">
                    <div class="price-card text-center mb-4">
                        <h3 class="price-card-title">Language Classes</h3>
                        <div class="price-card-cost">
                            <sup class="ti-money"></sup>
                        ...
                        <ul class="list">
                            <li class="list-item">Spanish <span class="text-muted">& English</span></li>
                            <li class="list-item">All <span class="text-muted">Levels</span></li>
                            <li class="list-item">Customized <span class="text-muted">Lessons</span></li>
                            <li class="list-item">Flexible <span class="text-muted">Schedule</span></li>
                        </ul>
                        <a href="#contact">
                            <button class="btn btn-primary btn-rounded w-lg">Get a Quote</button>
                        </a>
                ...
                <div class="col-md-6 col-lg-3">
    <div class="price-card text-center mb-4">
        <h3 class="price-card-title">Web Design </h3>
        <div class="price-card-cost">
            <sup class="ti-money"></sup>
            <span class="num">100</span>
            <span class="date">starting at</span>
        </div>
        <ul class="list">
            <li class="list-item">Landing <span class="text-muted">Page</span></li>
            <li class="list-item">Business <span class="text-muted">Website</span></li>
            <li class="list-item">Online <span class="text-muted">Store</span></li>
            <li class="list-item">Inventory <span class="text-muted">System</span></li>
            <li class="list-item">Hosting <span class="text-muted">Included</span></li>
        </ul>
        <a href="#contact">
            <button class="btn btn-primary btn-rounded w-lg">Get a Quote</button>
        </a>
    ...
    <section class="section bg-dark py-5">
        <div class="container text-center">
            ...
            <a href="#contact" class="btn bg-primary w-lg">Hire me</a>
        </div>
    </section>
        ...
        <div class="container">
            ...
            <div class="portfolio">
                ...
                <div class="portfolio-container"> 
                    ...
                    <div class="col-md-6 col-lg-4 web new">
                        <a href="https://drive.google.com/file/d/16YVLHaSq96kbfjfDHZX04pWF5BpsW1I7/view?usp=drive_link" target="_blank" style="display: block; text-decoration: none;">
                            <div class="portfolio-item">
                                <img src="copy.png" class="img-fluid" alt="Translation Work Sample">
                                <div class="content-holder">
                                    <div class="text-holder">
                                        <h6 class="title">TRANSLATION</h6>
                    ...
                    <div class="contact-form-card">
                        ...
                        <form action="{{ route('contact.submit') }}" method="POST">
                            ...
                            <div class="form-group">
                                <input name="name" class="form-control" type="text" placeholder="Name *" value="{{ old('name') }}" required>
                            </div>
                            <div class="form-group">
                                <input name="email" class="form-control" type="email" placeholder="Email *" value="{{ old('email') }}" required>
                            </div>
                            <div class="form-group">
                                <textarea name="message" class="form-control" placeholder="Message *" rows="7" required>{{ old('message') }}</textarea>
                            </div>
                            <div class="form-group">
                ...
                <div class="col-lg-4">
                    <div class="contact-info-card">
                        ...
                        <div class="row mb-2">
                            ...
                            <div class="col-10">
                                <h6 class="d-inline">Phone :<br> <span class="text-muted">+506 8968-1451</span></h6>
                            </div>
                        </div>
                        <div class="row mb-2">
                            <div class="col-1 pt-1 mr-1">
                            ...
                            <div class="col-10">
                                <h6 class="d-inline">Location :<br> <span class="text-muted">Jaco Beach, Costa Rica</span></h6>
                            </div>
                        </div>
                        <div class="row mb-2">
                            <div class="col-1 pt-1 mr-1">
                            ...
                            <div class="col-10">
                                <h6 class="d-inline">Email :<br> <a href="mailto:nachobonilla6@gmail.com" class="text-muted">nachobonilla6@gmail.com</a></h6>
                            </div>
                        </div>
    ...
    <footer class="footer py-3">
        <div class="container">
            <p class="small mb-0 text-light">
                &copy; <script>document.write(new Date().getFullYear())</script> Ignacio Bonilla. All rights reserved.
            </p>
        </div>
    </footer>
